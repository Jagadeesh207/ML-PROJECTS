"""
train.py
- Loads CSV with case-adjusted column names ('Yield', 'Soil_Moisture')
- Preprocesses (drop ph if present)
- Trains:
    - RandomForestClassifier for crop recommendation
    - RandomForestRegressor for yield prediction
    - A Keras ANN regressor for yield prediction
- Performs randomized hyperparameter search / anti-overfitting measures
- Saves models and preprocessing pipeline
"""
